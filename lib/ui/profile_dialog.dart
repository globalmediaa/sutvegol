...
Future<void> showProfileDialog(BuildContext context, LbEntry e) =>
    showDialog<void>(
      context: context,
...
class _ProfileCardState extends State<_ProfileCard> {
                ...
                children: [
                      ...
                      children: [
                          ...
                          children: [
                            Container(
                              decoration: BoxDecoration(
                                ...
                                boxShadow: FK.glow(20, alpha: 0.4, dy: 6),
                              ),
                              child: AvatarCircle(
                        ...
                        Transform.translate(
                          ...
                          child: Container(
                            ...
                            decoration: BoxDecoration(
                              color: FK.navy.withValues(alpha: 0.85),
                  ...
                  Positioned(
                    ...
                    child: RoundButton(
                      ...
                      size: 32,
                      color: FK.navy.withValues(alpha: 0.7),
                      ...
                      children: [
                        ...
                        GestureDetector(
                          ...
                          child: _pill(
                            Icons.favorite,
                            '$_likes',
                            iconColor: _liked ? FK.red : Colors.white,
                          ),
                        ),
                      ],
                    ),
                ...
                for (var i = 0; i < pageCount; i++)
                  AnimatedContainer(
                    ...
                    decoration: BoxDecoration(
                      ...
                      color: i == _page ? FK.orange : FK.glassBorder,
                    ),
                  ),
              ],
            ),
  ...
  Widget _pill(IconData icon, String text, {Color iconColor = Colors.white}) =>
      Container(
        padding: const EdgeInsets.symmetric(horizontal: 14, vertical: 6),
        decoration: BoxDecoration(
          color: FK.navy.withValues(alpha: 0.8),
        ...
        children: [
          Container(
            ...
            decoration: BoxDecoration(
              ...
              borderRadius: BorderRadius.circular(18),
              border: Border.all(
                color: b.outline ? color : Colors.white.withValues(alpha: 0.25),
                width: b.outline ? 2 : 1,
              ),
              boxShadow: b.outline
                  ? null
            ...
            child: b.icon != null
                ? Icon(
                    b.icon,
                    color: b.outline ? color : Colors.white,
                    size: 26,
                  )
                : Text(
                    b.text!,
                    style: FK.t(
                      size: b.text!.length > 2 ? 14 : 20,
                      w: FontWeight.w700,
                      color: b.outline ? color : Colors.white,
                    ),
                  ),
          ...
          Text(
            ...
            maxLines: 3,
            style: FK.t(size: 10.5, color: const Color(0xFFDDE4F5)),
          ),
        ],
      ),
    );
    ...
    canvas.drawRect(
      ...
      Paint()
        ..shader = const LinearGradient(
          ...
          colors: [Color(0xFF1F7A3C), Color(0xFF14522A)],
...
class _StreetPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    canvas.drawRect(
      Offset.zero & size,
      Paint()..color = const Color(0xFF8E4B36),
    );
    final mortar = Paint()
    ...
    canvas.drawRect(
      ...
      Paint()..color = const Color(0xFF3B3F4A),
    );
    final chalk = Paint()
